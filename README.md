...
теперь каждое изменение записывается как отдельный обьект для каждого из случаев(либо просто поле, либо void, либо bool),

добавлено хранение изменений до момента выпадения ошибки или до момента записи в новую структуру

при помощи перегрузки знака "=" заменили применение присваивания на сохранение обьекта изменения 